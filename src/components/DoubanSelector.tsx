...
const DoubanSelector: React.FC<DoubanSelectorProps> = ({
  ...
  const renderCapsuleSelector = (
    ...
    return (
      <div
        ref={containerRef}
        className='relative inline-flex bg-gray-200/60 dark:bg-surface/60 rounded-full p-0.5 sm:p-1 backdrop-blur-sm'
      >
        {/* 滑动的白色背景指示器 */}
        {indicatorStyle.width > 0 && (
          <div
            className='absolute top-0.5 bottom-0.5 sm:top-1 sm:bottom-1 bg-neon/80 rounded-full shadow-sm dark:shadow-[0_0_8px_rgba(82,99,255,0.3)] transition-all duration-300 ease-out'
            style={{
      ...
      {type === 'movie' && (
        <div className='space-y-3 sm:space-y-4'>
          ...
          <div className='flex flex-col sm:flex-row sm:items-center gap-2'>
            <span className='text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 min-w-[48px]'>
              分类
            </span>
